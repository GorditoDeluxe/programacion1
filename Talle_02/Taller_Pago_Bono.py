nom = input("Escriba su nombre y apellido: ")
ident = int(input("Introduzca su num de identificación personal, sin guiones: "))
edad = int(input("Introduzca su edad: "))
sexo = input("Introduzca su sexo (hombre o mujer): ")
salario = float(input("Ingrese su salario: "))
ml = int(input("Cuantos meses ha trabajado para la empresa: "))
inp = int(input("Introduzca el indice de productividad: "))
bono = (salario*ml) / 250
pb = bono/salario*100
sb = salario + bono
db= bono/3
...
while not mes_valido : 
    ...
    print (F"{nom}, {sexo} de {edad} años con idetificacion: {ident}, \ngracias por estar con nosotros durante estos {ml} meses. \nSu sueldo base es de: {salario: .2f} \nEl % del bono con respecto a su salario es de: {pb: .2f} \nSu salario base sumado con el bono es de: {sb: .2f}")
    print (f"El bono es de {bono: .2f}, y se dividira en 3 pagos de: {db: .2f}, los cuales se le entregarán en los meses correspondientes")